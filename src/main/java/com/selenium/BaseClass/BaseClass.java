...
public class BaseClass {
    ...
    protected static ExtentReports extentReporter = new ExtentReports();
    protected static Logger logger = LogManager.getLogger();
    private static ExtentHtmlReporter extentHtmlReporter = new ExtentHtmlReporter("Reports.html");
